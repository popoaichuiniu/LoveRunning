 ...
 * @data 2012-2-20
 */
public class MyLogPerfect {
    private  Boolean MYLOG_SWITCH=true; // 日志文件总开关
    private Boolean MYLOG_WRITE_TO_FILE=true;// 日志写入文件开关
    private char MYLOG_TYPE='v';// 输入日志类型，w代表只输出告警信息等，v代表输出所有信息
    private  String MYLOG_PATH_SDCARD_DIR="/sdcard/";// 日志文件在sdcard中的路径
    private  int SDCARD_LOG_FILE_SAVE_DAYS = 0;// sd卡中日志文件的最多保存天数
    private  String MYLOGFILEName = "Log.txt";// 本类输出的日志文件名称
    ...
    public MyLogPerfect(String MYLOGFILEName) {
